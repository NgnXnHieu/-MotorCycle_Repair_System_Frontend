...
const PersonnelBranchManagement = () => {
    ...
    // SỬA LẠI THÀNH:
    const [filters, setFilters] = useState({ searchName: '', role: '', isActive: '' });
    ...
    useEffect(() => {
        const fetchInitialData = async () => {
            try {
                ...
                const roleRes = await employeeApi.getRole4GBM();
                const role4GBMRes = await employeeApi.getRole4BM();
    ...
    const fetchEmployees = useCallback(async () => {
        try {
            ...
            const res = await employeeApi.getFiltedEmployee4BM({ params });
            console.log(res)
...
export default PersonnelBranchManagement;